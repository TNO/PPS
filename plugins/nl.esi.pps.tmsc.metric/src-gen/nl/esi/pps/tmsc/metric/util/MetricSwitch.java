...
public class MetricSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case MetricPackage.METRIC_CATEGORY: {
			MetricCategory metricCategory = (MetricCategory) theEObject;
			T result = caseMetricCategory(metricCategory);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case MetricPackage.METRIC_INSTANCE: {
			...
			if (result == null)
				result = caseInterval(metricInstance);
			if (result == null)
				result = casePropertiesContainer(metricInstance);
			if (result == null)
				result = caseITimeRange(metricInstance);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	 ...
	 * @generated
	 */
	public T caseMetricCategory(MetricCategory object) {
		return null;
	}
