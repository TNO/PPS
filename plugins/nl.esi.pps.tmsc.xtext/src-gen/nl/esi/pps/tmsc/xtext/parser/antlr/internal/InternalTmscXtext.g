...
entryRuleXTmscAnalysis returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getXTmscAnalysisRule()); }
	iv_ruleXTmscAnalysis=ruleXTmscAnalysis
	{ $current=$iv_ruleXTmscAnalysis.current; }
	EOF;

// Rule XTmscAnalysis
ruleXTmscAnalysis returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleXTimeBoundAnalysis returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getXTimeBoundAnalysisRule()); }
	iv_ruleXTimeBoundAnalysis=ruleXTimeBoundAnalysis
	{ $current=$iv_ruleXTimeBoundAnalysis.current; }
	EOF;

// Rule XTimeBoundAnalysis
ruleXTimeBoundAnalysis returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		...
		(
			...
			(
				...
				(
					(
						lv_defaultTimeBound_5_0=RULE_ABS_EBIGDECIMAL
						{
...
entryRuleXHost returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getXHostRule()); }
	iv_ruleXHost=ruleXHost
	{ $current=$iv_ruleXHost.current; }
	EOF;

// Rule XHost
ruleXHost returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleFQNString returns [String current=null]:
	{ newCompositeNode(grammarAccess.getFQNStringRule()); }
	iv_ruleFQNString=ruleFQNString
	{ $current=$iv_ruleFQNString.current.getText(); }
	EOF;

// Rule FQNString
ruleFQNString returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()]
@init {
	enterRule();
}
@after {
