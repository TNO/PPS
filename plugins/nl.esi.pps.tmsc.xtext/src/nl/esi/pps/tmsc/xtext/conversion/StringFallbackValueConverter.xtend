...
class StringFallbackValueConverter implements IValueConverter<String> {
    val IValueConverter<String> fallbackValueConverter
    val IValueConverter<String> stringValueConverter

    /** Prefer ID with fallback to STRING */
    override toString(String value) throws ValueConverterException {
        try {
            return fallbackValueConverter.toString(value)
    ...
    override toValue(String string, INode node) throws ValueConverterException {
        return if (string !== null && (string.startsWith('"') || string.startsWith("'"))) {
            ...
            fallbackValueConverter.toValue(string, node)
        } 
    }
}
