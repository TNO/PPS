 ...
 * </p>
 * <ul>
 *   <li>{@link nl.esi.pps.tmsc.impl.ExitEventImpl#getExecution <em>Execution</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExitEventImpl extends EventImpl implements ExitEvent {
	/**
	...
	protected EClass eStaticClass() {
		return TmscPackage.Literals.EXIT_EVENT;
	}
	...
	public NotificationChain basicSetExecution(Execution newExecution, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					TmscPackage.EXIT_EVENT__EXECUTION, oldExecution, newExecution);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setExecution(Execution newExecution) {
		if (newExecution != execution) {
			...
			if (execution != null)
				msgs = ((InternalEObject) execution).eInverseRemove(this, TmscPackage.EXECUTION__EXIT, Execution.class,
						msgs);
			if (newExecution != null)
				msgs = ((InternalEObject) newExecution).eInverseAdd(this, TmscPackage.EXECUTION__EXIT, Execution.class,
						msgs);
			msgs = basicSetExecution(newExecution, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TmscPackage.EXIT_EVENT__EXECUTION, newExecution,
					newExecution));
	}
