 ...
 * <!-- end-user-doc -->
 * @see nl.esi.emf.properties.PropertiesPackage
 * @generated
 */
public class PropertiesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
		case PropertiesPackage.PROPERTIES_CONTAINER: {
			PropertiesContainer propertiesContainer = (PropertiesContainer) theEObject;
			T result = casePropertiesContainer(propertiesContainer);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case PropertiesPackage.PROPERTY_MAP_ENTRY: {
			@SuppressWarnings("unchecked")
			Map.Entry<String, Serializable> propertyMapEntry = (Map.Entry<String, Serializable>) theEObject;
	 ...
	 * @generated
	 */
	public T casePropertyMapEntry(Map.Entry<String, Serializable> object) {
		return null;
	}
