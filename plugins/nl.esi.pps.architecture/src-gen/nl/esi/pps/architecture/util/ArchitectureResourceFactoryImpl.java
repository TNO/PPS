 ...
 * <!-- end-user-doc -->
 * @see nl.esi.pps.architecture.util.ArchitectureResourceImpl
 * @generated
 */
public class ArchitectureResourceFactoryImpl extends ResourceFactoryImpl {
	 ...
	 * @generated
	 */
	private Resource createResourceGen(URI uri) {
		Resource result = new ArchitectureResourceImpl(uri);
		return result;
	}
	...
	public Resource createResource(URI uri) {
		...
		if (ArchitecturePlugin.isArchitectureBinaryCompressedFileExtension(uri.fileExtension())) {
