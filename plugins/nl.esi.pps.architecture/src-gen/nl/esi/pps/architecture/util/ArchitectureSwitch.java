...
public class ArchitectureSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
		case ArchitecturePackage.NAMED_ARCHITECTURE_ELEMENT: {
			NamedArchitectureElement namedArchitectureElement = (NamedArchitectureElement) theEObject;
			T result = caseNamedArchitectureElement(namedArchitectureElement);
			if (result == null)
				result = casePropertiesContainer(namedArchitectureElement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ArchitecturePackage.ARCHITECTURE_MODEL: {
