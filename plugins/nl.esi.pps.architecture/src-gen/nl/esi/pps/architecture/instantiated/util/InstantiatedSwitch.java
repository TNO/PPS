 ...
 * @generated
 */
public class InstantiatedSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case InstantiatedPackage.EXECUTOR: {
			...
			if (result == null)
				result = caseNamedArchitectureElement(executor);
			if (result == null)
				result = casePropertiesContainer(executor);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case InstantiatedPackage.EXECUTOR_GROUP: {
			ExecutorGroup executorGroup = (ExecutorGroup) theEObject;
			T result = caseExecutorGroup(executorGroup);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Executor Group</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Executor Group</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseExecutorGroup(ExecutorGroup object) {
		return null;
	}
