...
public class ExampleSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case ExamplePackage.EXAMPLE_ARCHITECTURE: {
			ExampleArchitecture exampleArchitecture = (ExampleArchitecture) theEObject;
			T result = caseExampleArchitecture(exampleArchitecture);
			if (result == null)
				result = casePropertiesContainer(exampleArchitecture);
			if (result == null)
				result = caseArchitectureModel(exampleArchitecture);
			if (result == null)
