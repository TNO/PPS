...
public class ETimestampFormatPropertyEditorFactory extends FormatPropertyEditorFactory {
	/**
	 * The property editor factory URI of this property editor factory.
	 */
	public static final URI PROPERTY_EDITOR_FACTORY_URI = URI
			.createURI("editor://nl.esi.pps.tmsc.text.ETimestampFormat/");

	public ETimestampFormatPropertyEditorFactory() {
		super(ETimestampFormat.eINSTANCE, PROPERTY_EDITOR_FACTORY_URI);
	}
}
