...
public class XtextActivator extends AbstractUIPlugin {
	...
	public static final String PLUGIN_ID = "nl.esi.pps.tmsc.xtext.ui";
	public static final String NL_ESI_PPS_TMSC_XTEXT_TMSCXTEXT = "nl.esi.pps.tmsc.xtext.TmscXtext";
	...
	protected com.google.inject.Module getRuntimeModule(String grammar) {
		if (NL_ESI_PPS_TMSC_XTEXT_TMSCXTEXT.equals(grammar)) {
			return new TmscXtextRuntimeModule();
		}
	...
	protected com.google.inject.Module getUiModule(String grammar) {
		if (NL_ESI_PPS_TMSC_XTEXT_TMSCXTEXT.equals(grammar)) {
			return new TmscXtextUiModule(this);
		}
		throw new IllegalArgumentException(grammar);
	}
