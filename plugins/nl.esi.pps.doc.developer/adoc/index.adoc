...
. (The next steps are optional, yet advised) Install the PPS sources by again using the menu:Help[Install New Software...] menu.
  Now select the `PPS` category from the PPS (e.g., v0.30.0) update site: https://tno.github.io/PPS/update-site/v0.30.0/[] +
  Please make sure to select the right update site version for your installation.
