...
TIP: To run PPS with the custom TMSC reconstructor example, please use the context menu on the `nl.esi.pps.tmsc.reconstruct.ui` project and select menu:Run As[Eclipse Application].
